...
import RedSweaterCouple from "@/../../public/assets/RedSweaterCouple.png";

export default function UniverseDiv() {
  return (
    <div className="w-full h-auto mt-16">  {/* Use margin-top instead of absolute positioning */}
